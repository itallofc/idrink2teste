...
-- Insert demo stores (without owner_id for now - will be updated when merchants sign up)
-- We'll create a system user for demo data

-- First, let's insert the stores with a placeholder approach
-- The owner_id will be set to the first merchant that claims it
...
SELECT 
  ...
  'adega-do-moco',
  'Adega do Moco',
  'Selecao premium, entrega express.',
  'Especialistas em destilados premium e cervejas artesanais. A melhor adega da cidade.',
  '/logos/adega-do-moco-logo.jpeg',
  '/banners/adega-do-moco-banner.png',
  4.9,
  243,
  7.99,
  30.00,
...
SELECT 
  ...
  '/logos/zero-lounge-tabacaria-logo.jpeg',
  '/banners/zero-lounge-tabacaria-banner.png',
  4.7,
  89,
  6.99,
  25.00,
...
SELECT 
  ...
  'bebidas-on',
  'Bebidas ON',
  'Conectando voce ao melhor.',
  'Tudo ON para sua festa! Maior variedade, menor preco e entrega garantida.',
  '/logos/bebidas-on-logo.jpeg',
  '/banners/bebidas-on-banner.png',
  4.9,
  312,
  3.99,
  10.00,
